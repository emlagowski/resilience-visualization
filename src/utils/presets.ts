...
export const presets: ScenarioConfig[] = [
  // ─── 1. Mobile App → 2x BFF → LB → 3x Backend ─────────────────
  {
    name: 'Mobile App → 2x BFF → LB → 3x Backend',
    description: 'Mobile App → LB (external) → 2 BFFs with CB → LB (internal) → 3 backends. Kill backends to see CB trip.',
    nodes: [
      makeNode('n-am', 'Mobile App', 65, 257, {
        isSource: true,
      ...
      makeNode('node-1', 'LB (external)', 364, 257, {
        threadPool: { max: 200, active: 0 },
        connectionPool: { max: 200, active: 0 },
        timeout: 5000,
      ...
      makeNode('n-bff-1', 'BFF-1', 636, 153, {
        threadPool: { max: 80, active: 0 },
        connectionPool: { max: 80, active: 0 },
        timeout: 3000,
        processingTime: { min: 100, max: 200 },
        queueSize: 20,
        queueTimeout: 500,
        miniChartMode: 'latency',
        circuitBreaker: {
      ...
      makeNode('n-bff-2', 'BFF-2', 636, 353, {
        threadPool: { max: 80, active: 0 },
        connectionPool: { max: 80, active: 0 },
        timeout: 3000,
        processingTime: { min: 100, max: 200 },
      ...
      makeNode('n-f5', 'LB (internal)', 937, 254, {
        threadPool: { max: 200, active: 0 },
        connectionPool: { max: 200, active: 0 },
        timeout: 5000,
        processingTime: { min: 10, max: 20 },
      ...
      makeNode('n-be1', 'Backend #1', 1248, 51, {
        threadPool: { max: 50, active: 0 },
        connectionPool: { max: 1, active: 0 },
        timeout: 3000,
      ...
      makeNode('n-be2', 'Backend #2', 1248, 251, {
        threadPool: { max: 50, active: 0 },
        connectionPool: { max: 1, active: 0 },
        timeout: 3000,
        processingTime: { min: 1000, max: 1200 },
      ...
      makeNode('n-be3', 'Backend #3', 1248, 451, {
        threadPool: { max: 50, active: 0 },
        connectionPool: { max: 1, active: 0 },
        timeout: 3000,
        processingTime: { min: 1000, max: 1200 },
    ...
    edges: [
      { id: 'xy-edge__n-am-node-1', source: 'n-am', target: 'node-1' },
      { id: 'xy-edge__node-1-n-bff-1', source: 'node-1', target: 'n-bff-1' },
      { id: 'xy-edge__node-1-n-bff-2', source: 'node-1', target: 'n-bff-2' },
      { id: 'xy-edge__n-bff-1-n-f5', source: 'n-bff-1', target: 'n-f5' },
