  ...
  // ─── 1. Classic BFF → LB → 3 backends ─────────────────────────
  {
    ...
    nodes: [
      makeNode('n-am', 'Mobile App', 50, 250, {
        ...
        connectionPool: { max: 20, active: 0 },
        timeout: 5000,
      }),
      makeNode('n-bff', 'BFF', 350, 250, {
        threadPool: { max: 30, active: 0 },
        connectionPool: { max: 25, active: 0 },
        timeout: 3000,
    ...
    edges: [
      { id: 'e1', source: 'n-am', target: 'n-bff' },
      { id: 'e2', source: 'n-bff', target: 'n-f5' },
      { id: 'e3', source: 'n-f5', target: 'n-be1' },
      { id: 'e4', source: 'n-f5', target: 'n-be2' },
      { id: 'e5', source: 'n-f5', target: 'n-be3' },
    ],
  },
